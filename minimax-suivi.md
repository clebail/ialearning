...
Reste à faire :
- [ ] Cas de base du minimax (scoring +1 / 0 / -1 selon le gagnant)
- [ ] Algorithme minimax récursif (alternance max/min) + coup choisi par l'IA
- [ ] Brancher l'IA après le coup du joueur

> Point de vigilance pour la suite : l'**alternance min/max** (maximiser à son tour, minimiser au tour adverse) — c'est là que ça coince presque toujours.
